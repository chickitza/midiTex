...
static void createModuleCodeObjects(void) {
    ...
    codeobj_cb3e65437a7353b2117dfa921a5e8a47 = MAKE_CODE_OBJECT(module_filename_obj, 14, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[23], mod_consts[23], mod_consts[83], NULL, 1, 0, 0);
...
static PyObject *impl_PySide6$$$function__3__find_all_qt_modules(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_1:;
    {
        ...
        tmp_assign_source_3 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_2, mod_consts[47], tmp_args_element_value_2);
        if (tmp_assign_source_3 == NULL) {
            assert(ERROR_OCCURRED());
