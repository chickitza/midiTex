...
// Mark the execution in the "__spec__" value.
    ...
    branch_end_3:;
    {
        ...
        frame_222ef94f6cf970b6cabfaefdf6f8bcb9_2 = MAKE_CLASS_FRAME(codeobj_222ef94f6cf970b6cabfaefdf6f8bcb9, module_multiprocessing$$45$postLoad, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStack(frame_222ef94f6cf970b6cabfaefdf6f8bcb9_2);
        assert(Py_REFCNT(frame_222ef94f6cf970b6cabfaefdf6f8bcb9_2) == 2);
