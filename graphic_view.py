...
from PySide6.QtWidgets import (QAbstractScrollArea, QApplication, QGraphicsView, QSizePolicy,
    QVBoxLayout, QWidget)
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"Graphic View", None))
    # retranslateUi
